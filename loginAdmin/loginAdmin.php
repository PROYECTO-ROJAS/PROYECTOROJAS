...
<html lang="es">
    ...
    <body style="background-image: url(../../Img/fondo5.jpg)"> <!--Navbar-->
    <!--LOGIN-->
                        ...
                        <div class="container cuadroAdmin sombraA4" align="center">  
                            ...
                            <div class="row justify-content-center " >
                                ...
                                <div class="form-floating mb-3 " >
                                    <input type="text" style="border-radius: 50px;"name="usuario" class="form-control" id="floatingInput" placeholder="name@example.com">
                                    <label for="floatingInput">Email <i class="bi bi-person"></i></label>
                                </div>
                                <div class="form-floating">
                                    <input type="password"style="border-radius: 50px;"  name="clave" class="form-control" id="floatingPassword" placeholder="Password">
