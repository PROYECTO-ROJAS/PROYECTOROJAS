<?php session_start();
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if (empty($usuario) or empty($clave) or empty($clave2)){
            ...
            $statement = $conexion->prepare('SELECT * FROM admin WHERE usuario = :usuario LIMIT 1');
        ...
        if ($error == ''){
            $statement = $conexion->prepare('INSERT INTO admin (id, usuario, clave) VALUES (null,  :usuario, :clave)');
